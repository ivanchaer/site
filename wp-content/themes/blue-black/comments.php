...
<h3 id="comment-title">Comments</h3>
	...
	<?php foreach ($comments as $comment) : ?>
       ...
       <div class="comments-arrow"></div>
        ...
        <div class="comment-info">On <?php comment_date('F d, Y') ?> <?php comment_author_link() ?> says: </div> 
...
<p style="padding-left: 5px;"><small><strong>XHTML:</strong> You can use these tags: <code><?php echo allowed_tags(); ?></code></small></p>
